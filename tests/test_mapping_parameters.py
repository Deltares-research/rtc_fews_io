...
def test_data_config_reads_rtc_tools_mappings():
    ...
    assert config.variable(PiSeriesKey("unknown", "parameter", ("q",))) == "unknown:parameter:q"
...
<rtcDataConfig xmlns="http://www.wldelft.nl/fews">
  <import><PITimeSeriesFile><timeSeriesFile>custom_import.xml</timeSeriesFile></PITimeSeriesFile></import>
  <export><PITimeSeriesFile><timeSeriesFile>custom_export.xml</timeSeriesFile></PITimeSeriesFile></export>
  <timeSeries id="a"><PITimeSeries><locationId>L</locationId><parameterId>P</parameterId><qualifierId>Q</qualifierId></PITimeSeries></timeSeries>
</rtcDataConfig>
''',
    )
    ...
    _write(
        tmp_path / "rtcDataConfig.xml",
        '''<rtcDataConfig xmlns="http://www.wldelft.nl/fews">
  <timeSeries id="a"><PITimeSeries><locationId>L</locationId><parameterId>P</parameterId></PITimeSeries></timeSeries>
  <timeSeries id="b"><PITimeSeries><locationId>L</locationId><parameterId>P</parameterId></PITimeSeries></timeSeries>
</rtcDataConfig>
''',
    )
